{{-- Placeholder artikel — nanti bisa dihubungkan ke tabel database kalau sudah ada CMS/admin --}}
<section id="insights" class="bg-konsit-cream py-16 sm:py-24 scroll-mt-20">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            @foreach ([
                ['tag' => 'Keamanan Siber', 'title' => 'Cara Melindungi Data Bisnis dari Serangan Ransomware', 'date' => '12 September 2026'],
                ['tag' => 'Manajemen SDM', 'title' => 'Strategi Talent Management di Era Kerja Hybrid', 'date' => '9 September 2026'],
                ['tag' => 'Kepatuhan', 'title' => 'Panduan Singkat Sertifikasi ISO untuk Perusahaan Manufaktur', 'date' => '5 September 2026'],
            ] as $post)
                <article class="group cursor-pointer">
                    ...
                    <p class="mt-2 text-sm text-konsit-ink/50">{{ $post['date'] }}</p>
                </article>
            @endforeach
        </div>
